...
import 'package:product_buy_sell/screens/admin/delivery_man/add_delivery_man.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: SizedBox(
        height: 50,
        child: CustomButton(
          btnTxt: 'Add Delivery Man',
          onTap: () {
            Helper.toScreen(context, AddDeliveryManScreen());
          },
          radius: 0,
        ),
      ),
      appBar: AppBar(
        title: CustomText(title: 'Delivery Man', textStyle: sfProStyle600SemiBold.copyWith(color: Colors.white, fontSize: 20)),
